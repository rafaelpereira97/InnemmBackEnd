        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header border-transparent">
                    <h3 class="card-title">Criar novo grupo</h3>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('group.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="description" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                        </div>

                        <label>Associar Bombeiros ao Grupo</label>
                        @foreach($bombeiros as $bombeiro)
                            <div class="form-check">
                                <input name="bombeiros[]" value="{{$bombeiro->id}}" type="checkbox" class="form-check-input" id="{{$bombeiro->id}}">
